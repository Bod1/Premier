...
<div align="center">
  <table width="900" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="880" colspan="2" align="left" valign="top"><!-- InstanceBeginEditable name="banner" --><img src="Images/main_banner_contact.jpg" alt="Main Banner" width="880" height="242" border="0" usemap="#Map"/>
...
<!-- InstanceBeginEditable name="Nav" --><a href="index.html" onMouseOver="nav1.src='Images/nav_home_ov.gif';" onMouseOut="nav1.src='Images/nav_home.gif';"><img src="Images/nav_home.gif" alt="Home" name="nav1" width="220" height="35" border="0" id="nav1" /></a><br />
              ...
              <a href="travel.html" onMouseOver="nav3.src='Images/nav_travel_benefits_ov.gif';" onMouseOut="nav3.src='Images/nav_travel_benefits.gif';"><img src="Images/nav_travel_benefits.gif" alt="Travel Benefits" name="nav3" width="220" height="31" border="0" id="nav3" /></a><br />
              <a href="sportsevents.html" onMouseOver="nav4.src='Images/nav_sports_ov.gif';" onMouseOut="nav4.src='Images/nav_sports.gif';"><img src="Images/nav_sports.gif" alt="Sports Events" name="nav4" width="220" height="29" border="0" id="nav4" /></a><br />
              <a href="globalsimcard.html" onMouseOver="nav5.src='Images/nav_globalsim_ov.gif';" onMouseOut="nav5.src='Images/nav_globalsim.gif';"><img src="Images/nav_globalsim.gif" alt="Global Sim Card" name="nav5" width="220" height="30" border="0" id="nav5" /></a><br />
              <a href="corporateprivileges.html" onMouseOver="nav6.src='Images/nav_corporate_ov.gif';" onMouseOut="nav6.src='Images/nav_corporate.gif';"><img src="Images/nav_corporate.gif" alt="Corporate Privileges" name="nav6" width="220" height="31" border="0" id="nav6" /></a><br />
              <a href="membership.html" onMouseOver="nav7.src='Images/nav_membership_ov.gif';" onMouseOut="nav7.src='Images/nav_membership.gif';"><img src="Images/nav_membership.gif" alt="Membership" name="nav7" width="220" height="30" border="0" id="nav7" /></a><br />
              <a href="contactus.asp"><img src="Images/nav_contact_on.gif" alt="Contact Us" name="nav8" width="220" height="30" border="0" id="nav8" /></a><br />
              <!-- InstanceEndEditable --></td>
              ...
              <table width="592" border="0" cellpadding="0" cellspacing="0" class="sectionbg">
                <tr>
                  ...
                  <td width="400" align="left" valign="top"><span class="H2">Contact Us</span> <br />
                    ...
                    +234 (0) 702 805 3951 / +234 (0) 702 805 3952 / +234 (0)702 805 3953<br />
                    <br />
                ...
                <tr>
                  ...
                  <td colspan="3" align="center" valign="top"><form name="Premierform" method="post" action="contactus.asp?post=1">
                      <table width="400" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td align="left" valign="top"><span class="labeltxt"> <img src="Images/bullet.gif" alt="bullet" width="12" height="12" /> Your Name <%=oContact.displayErrors("realname")%></span>
                            <label>
                            <input name="realname" type="text" class="formfield" id="realname" value="<%=oContact.keepData("realname","")%>"/>
                            </label></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><img src="Images/spacer.gif" alt="spacer" width="14" height="5" /></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><span class="labeltxt"> <img src="Images/bullet.gif" alt="bullet" width="12" height="12" /> Company Name <%=oContact.displayErrors("compName")%></span>
                            <label>
                            <input name="compName" type="text" class="formfield" id="compName" value="<%=oContact.keepData("compName","")%>"/>
                            </label></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><img src="Images/spacer.gif" alt="spacer" width="14" height="5" /></td>
                        ...
                        <tr>
                          <td align="left" valign="top"><span class="labeltxt"> <img src="Images/bullet.gif" alt="bullet" width="12" height="12" /> Email Address <%=oContact.displayErrors("email")%></span>
                            <label>
                            <input name="email" type="text" class="formfield" id="email" value="<%=oContact.keepData("email","")%>"/>
                            </label></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><img src="Images/spacer.gif" alt="spacer" width="14" height="5" /></td>
                        ...
                        <tr>
                          <td align="left" valign="top"><span class="labeltxt"> <img src="Images/bullet.gif" alt="bullet" width="12" height="12" /> Your Message <%=oContact.displayErrors("message")%></span>
                            <label>
                            <textarea name="message" rows="4" class="formfield" id="message"><%=oContact.keepData("message","")%></textarea>
                            </label></td>
                        </tr>
                        <tr>
                          <td><img src="Images/spacer.gif" alt="spacer" width="14" height="5" /></td>
                        </tr>
                        <tr>
